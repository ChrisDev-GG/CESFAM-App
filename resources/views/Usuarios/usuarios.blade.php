    ...
    <div class="container">
        <div class="row center-cards img-game">
            <div class="card col-3 spacing">
                <a href="/gestor/usuarios/admins"><img class="card-img-top admin-img" src="{{asset('img/admin.png')}}" alt="Card image cap" style="max-width: 170px; margin:auto;"></a>
                <div class="card-body">
            ...
            <div class="card col-3 spacing">
                <a href="/gestor/usuarios/users"><img class="card-img-top img-game simon" src="{{asset('img/users.webp')}}" alt="Card image cap" style="max-width: 290px; margin:auto;"></a>
                <div class="card-body">
